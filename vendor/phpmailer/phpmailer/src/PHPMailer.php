...
class PHPMailer
{
    ...
    public function setLanguage($langcode = 'en', $lang_path = '')
    {
        ...
        $PHPMAILER_LANG = [
            ...
            'file_open' => 'FileDTO Error: Could not open file: ',
     ...
     * @param string $encoding    FileDTO encoding (see $Encoding)
     ...
     * @param string $encoding    FileDTO encoding (see $Encoding)
     * @param string $type        FileDTO extension (MIME) type
     * @param string $disposition Disposition to use
     *
     * @throws Exception
     *
     ...
     * @param string $encoding    FileDTO encoding (see $Encoding) defaults to `base64`
     * @param string $type        FileDTO MIME type (by default mapped from the `$path` filename's extension)
     ...
     *
     * @param string $ext FileDTO extension
     *
